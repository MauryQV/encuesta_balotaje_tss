...
import { participacionSeccion5 } from "../../data/datosEncuesta";

const Seccion5ParticipacionPolitica = ({ datos, actualizarDato }) => (
...
export default Seccion5ParticipacionPolitica;
